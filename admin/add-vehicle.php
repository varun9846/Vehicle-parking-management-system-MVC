<?php
session_start();- // starts a session, allowing you to store and access session variables across different pages of  website.
error_reporting(0); //disables error reporting. 
include('includes/dbconnection.php');
if (strlen($_SESSION['vpmsaid']==0)) { //checks session vairable called vpms is empty or set that is only logged in users can access the page
  header('location:logout.php');
  } else{

if(isset($_POST['submit'])) //checks if form with name submit is submitted or not
  {
